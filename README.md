...
| 現在の状態 | 0.6 alpha、CSV 用例作成・単用例出力・選択出力・用例削除・復元・複数画像・連続撮影・動画添付、Windows ビルド検証済み | 0.2 alpha、Mac の実ブラウザで一連の操作を確認済み |
...
| Windows 原生版 | 104 Core checks、x64 ビルド、64 枚画像出力、64 MiB 添付、ステップ条件、Open XML / ExcelJS 検証 | Windows ウィンドウ、RDP、IME、DPI、プレーヤー連携、実 Excel の印刷・クリック |
