...
try {
    ...
    Copy-Item README.md, THIRD-PARTY-NOTICES.md, WINDOWS-ACCEPTANCE.md, QA.md, CAPTURE-DESIGN.md, ARCHITECTURE.md -Destination $target
    Copy-Item examples/case-template.csv -Destination $target
